var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.arrayIteratorImpl=function(l){var e=0;return function(){return e<l.length?{done:!1,value:l[e++]}:{done:!0}}};$jscomp.arrayIterator=function(l){return{next:$jscomp.arrayIteratorImpl(l)}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;
$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(l,e,P){l!=Array.prototype&&l!=Object.prototype&&(l[e]=P.value)};$jscomp.getGlobal=function(l){return"undefined"!=typeof window&&window===l?l:"undefined"!=typeof global&&null!=global?global:l};$jscomp.global=$jscomp.getGlobal(this);$jscomp.SYMBOL_PREFIX="jscomp_symbol_";$jscomp.initSymbol=function(){$jscomp.initSymbol=function(){};$jscomp.global.Symbol||($jscomp.global.Symbol=$jscomp.Symbol)};
$jscomp.SymbolClass=function(l,e){this.$jscomp$symbol$id_=l;$jscomp.defineProperty(this,"description",{configurable:!0,writable:!0,value:e})};$jscomp.SymbolClass.prototype.toString=function(){return this.$jscomp$symbol$id_};$jscomp.Symbol=function(){function l(P){if(this instanceof l)throw new TypeError("Symbol is not a constructor");return new $jscomp.SymbolClass($jscomp.SYMBOL_PREFIX+(P||"")+"_"+e++,P)}var e=0;return l}();
...
Math.PI*2)/b}function g(a,c){if(1<c.length)for(var f=0;f<c.length;f++)g(a,c[f]);else t+=-Math.sign(a.x),t=t===b?0:t,t=0>t?b-1:t,C.dispatchEvent({type:"rotation",data:{currentSide:t}}),c.rotation.y+=-(Math.sign(a.x)*Math.PI*2)/b}function m(a,b){return a/b}function H(a,b,c,f,h,d){var e=6<arguments.length&&void 0!==arguments[6]?arguments[6]:!1,g=0;setTimeout(function Xa(){qa||(g++,t=(b+g)%f,z.rotation.y+=-(Math.sign(a)*Math.PI*2)/f,C.dispatchEvent({type:"rotation",data:{currentSide:t}}),e&&(g%=f),g===
c?C.dispatchEvent({type:"initial-auto-rotate-finished"}):setTimeout(Xa,d(h,c)))},d(h,c))}function n(a,b){if(F[b].enabled){if(1<z.length){for(var c=!0,f=0;f<z.length;f++){if(!c)return!1;F[b].enabled&&(c=!!(-1*F[b].from<z[f].rotation[b]+a&&z[f].rotation[b]+a<F[b].to))}return c}return!!(-1*F[b].from<z.rotation[b]+a&&z.rotation[b]+a<F[b].to)}return!0}function T(){r=!1;A=c=0}var p=5<arguments.length&&void 0!==arguments[5]?arguments[5]:0;this.setObjectToMove=function(a){z=a};this.setZoomSpeed=function(a){l=
a};this.setDistance=function(a,b){I=a;W=b};this.setRotationSpeed=function(a){};this.setRotationSpeedTouchDevices=function(a){q=a};this.enableVerticalRotation=function(){v=!0};this.disableVerticalRotation=function(){v=!1};this.enableHorizontalRotation=function(){x=!0};this.disableHorizontalRotation=function(){x=!1};this.setMaxVerticalRotationAngle=function(a,b){F.x.from=a;F.x.to=b;F.x.enabled=!0};this.setMaxHorizontalRotationAngle=function(a,b){F.y.from=a;F.y.to=b;F.y.enabled=!0};this.disableMaxHorizontalAngleRotation=
function(){F.y.enabled=!1};this.disableMaxVerticalAngleRotation=function(){F.x.enabled=!1};this.disableZoom=function(){w=!1};this.enableZoom=function(){w=!0};this.setIsZoomed=function(a){};d=void 0!==d?d:document;var F={x:{enabled:!1,from:Math.PI/8,to:Math.PI/8},y:{enabled:!1,from:Math.PI/4,to:Math.PI/4}},z=k,W=300,I=300,l=.5,q=2E-4,r=!1,qa=!1,v=!1,x=!0,w=!1;var A=c=0;var u=[],t=p,y={X:null,Y:null},C=this;this.animate=function(a){H(-1,1<arguments.length&&void 0!==arguments[1]?arguments[1]:0,b,b,3E3,
m,a)};d.addEventListener("mousedown",function(a){r=qa=!0;c=a.offsetX;A=a.offsetY},!1);d.addEventListener("mousemove",function(a){r&&x&&(h({x:a.offsetX-c,y:a.offsetY-A},z),c=a.offsetX,A=a.offsetY)},!1);d.addEventListener("mouseup",T,!1);d.addEventListener("mouseout",T,!1);d.addEventListener("touchstart",function(a){a.preventDefault();qa=!0;2===a.touches.length?(y.X=Math.abs(a.touches[0].clientX-a.touches[1].clientX),y.Y=Math.abs(a.touches[0].clientY-a.touches[1].clientY),u=Array(2)):(c=a.touches[0].pageX,
A=a.touches[0].pageY)},!1);d.addEventListener("touchmove",function(a){a.preventDefault();if(2===a.touches.length&&w){u=Array(2);var b=Math.abs(a.touches[0].clientX-a.touches[1].clientX);a=Math.abs(a.touches[0].clientY-a.touches[1].clientY);y&&0<y.X&&0<y.Y&&(b>y.X&&a>y.Y&&e.position.z>I?e.position.z-=l:b<y.X&&e.position.z<W&&a<y.Y&&(e.position.z+=l));y.X=b;y.Y=a}else if(0===u.length){y.X=null;y.Y=null;b={x:a.touches[0].pageX-c,y:a.touches[0].pageY-A};c=a.touches[0].pageX;A=a.touches[0].pageY;if(x&&
0!=b.x){if(!n(Math.sign(b.x)*q,"y"))return;g(b,z)}v&&0!=b.y&&n(Math.sign(b.y)*q,"x")&&f(b,z)}},!1);d.addEventListener("touchend",function(a){y.X=null;y.Y=null;0<u.length?u.pop():u=[];a.preventDefault();A=c=0},!1)}function fa(g,d,k){function a(){k.addEventListener("mousemove",c,!1);k.addEventListener("mousedown",f,!1);k.addEventListener("mouseup",h,!1);k.addEventListener("mouseleave",h,!1);k.addEventListener("touchmove",B,!1);k.addEventListener("touchstart",m,!1);k.addEventListener("touchend",H,!1)}
function b(){k.removeEventListener("mousemove",c,!1);k.removeEventListener("mousedown",f,!1);k.removeEventListener("mouseup",h,!1);k.removeEventListener("mouseleave",h,!1);k.removeEventListener("touchmove",B,!1);k.removeEventListener("touchstart",m,!1);k.removeEventListener("touchend",H,!1)}function c(a){a.preventDefault();var b=k.getBoundingClientRect();z.x=(a.clientX-b.left)/b.width*2-1;z.y=2*-((a.clientY-b.top)/b.height)+1;F.setFromCamera(z,d);l&&r.enabled?(F.ray.intersectPlane(p,I)&&l.position.copy(I.sub(W)),
r.dispatchEvent({type:"drag",object:l})):(F.setFromCamera(z,d),a=F.intersectObjects(g),0<a.length?(a=a[0].object,p.setFromNormalAndCoplanarPoint(d.getWorldDirection(p.normal),a.position),q!==a&&(r.dispatchEvent({type:"hoveron",object:a}),k.style.cursor="pointer",q=a)):null!==q&&(r.dispatchEvent({type:"hoveroff",object:q}),k.style.cursor="auto",q=null))}function f(a){a.preventDefault();F.setFromCamera(z,d);a=F.intersectObjects(g,n);0<a.length&&(l=a[0].object,F.ray.intersectPlane(p,I)&&W.copy(I).sub(l.position),
k.style.cursor="move",r.dispatchEvent({type:"dragstart",object:l}))}function h(a){a.preventDefault();l&&(r.dispatchEvent({type:"dragend",object:l}),l=null);k.style.cursor="auto"}function B(a){a.preventDefault();a=a.changedTouches[0];var b=k.getBoundingClientRect();z.x=(a.clientX-b.left)/b.width*2-1;z.y=2*-((a.clientY-b.top)/b.height)+1;F.setFromCamera(z,d);l&&r.enabled&&(F.ray.intersectPlane(p,I)&&l.position.copy(I.sub(W)),r.dispatchEvent({type:"drag",object:l}))}function m(a){a.preventDefault();
a=a.changedTouches[0];var b=k.getBoundingClientRect();z.x=(a.clientX-b.left)/b.width*2-1;z.y=2*-((a.clientY-b.top)/b.height)+1;F.setFromCamera(z,d);a=F.intersectObjects(g,n);0<a.length&&(l=a[0].object,p.setFromNormalAndCoplanarPoint(d.getWorldDirection(p.normal),l.position),F.ray.intersectPlane(p,I)&&W.copy(I).sub(l.position),k.style.cursor="move",r.dispatchEvent({type:"dragstart",object:l}))}function H(a){a.preventDefault();l&&(r.dispatchEvent({type:"dragend",object:l}),l=null);k.style.cursor="auto"}
var n=3<arguments.length&&void 0!==arguments[3]?arguments[3]:!1;if(g.isCamera){console.warn("THREE.DragControls: Constructor now expects ( objects, camera, domElement )");var T=g;g=d;d=T}var p=new e.Plane,F=new e.Raycaster,z=new e.Vector2,W=new e.Vector3,I=new e.Vector3,l=null,q=null,r=this;a();this.enabled=!0;this.activate=a;this.deactivate=b;this.dispose=function(){b()};this.setObjects=function(){console.error("THREE.DragControls: setObjects() has been removed.")};this.on=function(a,b){console.warn("THREE.DragControls: on() has been deprecated. Use addEventListener() instead.");
...
M=K.ROTATE;F.set(a.clientX,a.clientY)}else if(a.button===p.mouseButtons.ZOOM){if(!0===p.noZoom)return;M=K.DOLLY;y.set(a.clientX,a.clientY)}else if(a.button===p.mouseButtons.PAN){if(!0===p.noPan)return;M=K.PAN;I.set(a.clientX,a.clientY)}M!==K.NONE&&(document.addEventListener("mousemove",b,!1),document.addEventListener("mouseup",c,!1),p.dispatchEvent(Q))}}function b(a){if(!1!==p.enabled){a.preventDefault();var b=p.domElement===document?p.domElement.body:p.domElement;M===K.ROTATE?!0!==p.noRotate&&(z.set(a.clientX,
a.clientY),l.subVectors(z,F),0==F.x&&0==F.y?(F.set(z.x,z.y),l.subVectors(z,F)):(p.rotateLeft(2*Math.PI*l.x/b.clientHeight*p.rotateSpeed),p.rotateUp(2*Math.PI*l.y/b.clientHeight*p.rotateSpeed),F.copy(z))):M===K.DOLLY?!0!==p.noZoom&&(x.set(a.clientX,a.clientY),A.subVectors(x,y),0<A.y?p.dollyIn():0>A.y&&p.dollyOut(),y.copy(x)):M===K.PAN&&!0!==p.noPan&&(q.set(a.clientX,a.clientY),r.subVectors(q,I),p.pan(r.x,r.y),I.copy(q))}}function c(){!1!==p.enabled&&(document.removeEventListener("mousemove",b,!1),
document.removeEventListener("mouseup",c,!1),p.dispatchEvent(R),M=K.NONE)}function f(a){if(!1!==p.enabled&&!0!==p.noZoom&&M===K.NONE){a.preventDefault();a.stopPropagation();var b=0;void 0!==a.wheelDelta?b=a.wheelDelta:void 0!==a.detail&&(b=-a.detail);0<b?(p.object.fov=p.object.fov<p.maxFov?p.object.fov+1:p.maxFov,p.object.updateProjectionMatrix()):0>b&&(p.object.fov=p.object.fov>p.minFov?p.object.fov-1:p.minFov,p.object.updateProjectionMatrix());p.object.fov<=p.maxFov&&(p.dispatchEvent(N),p.dispatchEvent(Q),
p.dispatchEvent(R),p.dispatchEvent(S))}}function h(a){}function B(a){if(!1!==p.enabled&&!0!==p.noKeys&&!0!==p.noRotate){p.autoRotate&&(clearTimeout(this.autoRotateRequestId),p.autoRotate=!1,this.autoRotateRequestId=window.setTimeout(function(){p.autoRotate=!0},5E3));var b=p.momentum&&!p.autoRotate?p.momentumKeydownFactor*p.momentumFactor:p.momentumKeydownFactor;switch(a.keyCode){case p.keys.UP:p.rotateUp(p.rotateSpeed*b);break;case p.keys.BOTTOM:p.rotateUp(-p.rotateSpeed*b);break;case p.keys.LEFT:p.rotateLeft(p.rotateSpeed*
b);break;case p.keys.RIGHT:p.rotateLeft(-p.rotateSpeed*b)}}}function m(a){if(!1!==p.enabled){switch(a.touches.length){case 1:if(!0===p.noRotate)return;M=K.TOUCH_ROTATE;F.set(a.touches[0].pageX,a.touches[0].pageY);break;case 2:if(!0===p.noZoom)return;M=K.TOUCH_DOLLY;var b=a.touches[0].pageX-a.touches[1].pageX;a=a.touches[0].pageY-a.touches[1].pageY;y.set(0,Math.sqrt(b*b+a*a));break;case 3:if(!0===p.noPan)return;M=K.TOUCH_PAN;I.set(a.touches[0].pageX,a.touches[0].pageY);break;default:M=K.NONE}M!==K.NONE&&
p.dispatchEvent(Q)}}function H(a){if(!1!==p.enabled){a.preventDefault();a.stopPropagation();var b=p.domElement===document?p.domElement.body:p.domElement;switch(a.touches.length){case 1:var c=.38*p.rotateSpeed;if(!0===p.noRotate)break;if(M!==K.TOUCH_ROTATE)break;z.set(a.touches[0].pageX,a.touches[0].pageY);l.subVectors(z,F);p.rotateLeft(2*Math.PI*l.x/b.clientHeight*c);p.rotateUp(2*Math.PI*l.y/b.clientHeight*c);F.copy(z);break;case 2:if(!0===p.noZoom)break;if(M!==K.TOUCH_DOLLY)break;b=a.touches[0].pageX-
a.touches[1].pageX;a=a.touches[0].pageY-a.touches[1].pageY;x.set(0,Math.sqrt(b*b+a*a));A.subVectors(x,y);0>A.y?(p.object.fov=p.object.fov<p.maxFov?p.object.fov+1:p.maxFov,p.object.updateProjectionMatrix()):0<A.y&&(p.object.fov=p.object.fov>p.minFov?p.object.fov-1:p.minFov,p.object.updateProjectionMatrix());y.copy(x);p.dispatchEvent(N);p.dispatchEvent(S);break;case 3:if(!0===p.noPan)break;if(M!==K.TOUCH_PAN)break;q.set(a.touches[0].pageX,a.touches[0].pageY);r.subVectors(q,I);p.pan(r.x,r.y);I.copy(q);
break;default:M=K.NONE}}}function n(){!1!==p.enabled&&(p.dispatchEvent(R),M=K.NONE)}var T=2<arguments.length&&void 0!==arguments[2]?arguments[2]:{panSpeed:1};this.object=g;this.domElement=void 0!==d?d:document;this.panSpeed=T.panSpeed;this.frameId=null;this.enabled=!0;this.center=this.target=new e.Vector3;this.noZoom=!1;this.zoomSpeed=1;this.minDistance=0;this.maxDistance=Infinity;this.minZoom=0;this.maxZoom=Infinity;this.noRotate=!1;this.rotateSpeed=-.15;this.noPan=!0;this.keyPanSpeed=7;this.autoRotate=
!1;this.autoRotateSpeed=2;this.minPolarAngle=0;this.maxPolarAngle=Math.PI;this.momentumKeydownFactor=.05;this.speedLimit=.04;this.publicSphericalDelta=new e.Spherical;this.momentum=!0;this.momentumFactor=7.5;this.enableDamping=!0;this.dampingFactor=.03;this.minFov=30;this.maxFov=120;this.minAzimuthAngle=-Infinity;this.maxAzimuthAngle=Infinity;this.noKeys=!1;this.keys={LEFT:37,UP:38,RIGHT:39,BOTTOM:40};this.mouseButtons={ORBIT:e.MOUSE.LEFT,ZOOM:e.MOUSE.MIDDLE,PAN:e.MOUSE.RIGHT};var p=this,F=new e.Vector2,
z=new e.Vector2,l=new e.Vector2,I=new e.Vector2,q=new e.Vector2,r=new e.Vector2,v=new e.Vector3,t=new e.Vector3,y=new e.Vector2,x=new e.Vector2,A=new e.Vector2,w=0,u=0,C=0,D=0,E=1,G=new e.Vector3,J=new e.Vector3,L=new e.Quaternion,K={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_DOLLY:4,TOUCH_PAN:5},M=K.NONE;this.target0=this.target.clone();this.position0=this.object.position.clone();this.zoom0=this.object.zoom;var O=(new e.Quaternion).setFromUnitVectors(g.up,new e.Vector3(0,1,0)),P=O.clone().invert(),
N={type:"change"},Q={type:"start"},R={type:"end"},S={type:"fov"};this.setLastQuaternion=function(a){L.copy(a);p.object.quaternion.copy(a)};this.getLastPosition=function(){return J};this.rotateLeft=function(a){void 0===a&&(a=k());a=this.momentum&&!this.autoRotate?a/=this.momentumFactor:a;D-=a};this.rotateUp=function(a){void 0===a&&(a=k());a=this.momentum&&!this.autoRotate?a/=this.momentumFactor:a;C-=a};this.rotateLeftStatic=function(a){this.enableDamping=!1;D-=a;this.update();this.enableDamping=!0};
...
u));u=Math.max(1E-7,Math.min(Math.PI-1E-7,u));a=t.length()*E;a=Math.max(this.minDistance,Math.min(this.maxDistance,a));this.target.add(G);t.x=a*Math.sin(u)*Math.sin(w);t.y=a*Math.cos(u);t.z=a*Math.sin(u)*Math.cos(w);t.applyQuaternion(P);f.copy(this.target).add(t);this.object.lookAt(this.target);E=1;G.set(0,0,0);if(1E-7<J.distanceToSquared(this.object.position)||1E-7<8*(1-L.dot(this.object.quaternion)))this.dispatchEvent(N),J.copy(this.object.position),L.copy(this.object.quaternion);p.enableDamping=
c};this.getRotations=function(){return{h:w,v:u}};this.panLeft=function(a){var b=this.object.matrix.elements;v.set(b[0],b[1],b[2]);v.multiplyScalar(-a);G.add(v)};this.panUp=function(a){var b=this.object.matrix.elements;v.set(b[4],b[5],b[6]);v.multiplyScalar(a);G.add(v)};this.pan=function(a,b){var c=p.domElement===document?p.domElement.body:p.domElement;if(p.object instanceof e.PerspectiveCamera){var f=p.object.position.clone().sub(p.target).length();f*=Math.tan(p.object.fov/2*Math.PI/180);p.panLeft(2*
...
Math.min(this.maxAzimuthAngle,w));u=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,u));u=Math.max(1E-7,Math.min(Math.PI-1E-7,u));var c=t.length()*E;c=Math.max(this.minDistance,Math.min(this.maxDistance,c));this.target.add(G);t.x=c*Math.sin(u)*Math.sin(w);t.y=c*Math.cos(u);t.z=c*Math.sin(u)*Math.cos(w);t.applyQuaternion(P);b.copy(this.target).add(t);this.object.lookAt(this.target);this.autoRotate||!0!==this.enableDamping||(!this.momentum||M!==K.ROTATE&&M!==K.TOUCH_ROTATE)&&M!==K.NONE?C=D=
0:(D*=1-this.dampingFactor,C*=1-this.dampingFactor);E=1;G.set(0,0,0);if(1E-7<J.distanceToSquared(this.object.position)||1E-7<8*(1-L.dot(this.object.quaternion)))!0!==a&&this.dispatchEvent(N),J.copy(this.object.position),L.copy(this.object.quaternion)};this.reset=function(){M=K.NONE;this.target.copy(this.target0);this.object.position.copy(this.position0);this.object.zoom=this.zoom0;this.object.updateProjectionMatrix();this.dispatchEvent(N);this.update()};this.getPolarAngle=function(){return u};this.getAzimuthalAngle=
function(){return w};this.dispose=function(){this.domElement.removeEventListener("mousedown",a,{passive:!1});this.domElement.removeEventListener("mousewheel",f,{passive:!1});this.domElement.removeEventListener("DOMMouseScroll",f,{passive:!1});this.domElement.removeEventListener("touchstart",m,{passive:!1});this.domElement.removeEventListener("touchend",n,{passive:!1});this.domElement.removeEventListener("touchmove",H,{passive:!1});window.removeEventListener("keyup",h,{passive:!1});window.removeEventListener("keydown",
...
k.enabled&&(k.deviceOrientation=a)},B=function(){k.screenOrientation=window.orientation||0},m=function(a){k.enabled&&(a.preventDefault(),a.stopPropagation(),c=a.touches[0].pageX,f=a.touches[0].pageY)},H=function(h){k.enabled&&(h.preventDefault(),h.stopPropagation(),a+=e.Math.degToRad((h.touches[0].pageX-c)/4),b+=e.Math.degToRad((f-h.touches[0].pageY)/4),k.updateAlphaOffsetAngle(a),c=h.touches[0].pageX,f=h.touches[0].pageY)};this.connect=function(){B();window.addEventListener("orientationchange",B,
{passive:!0});window.addEventListener("deviceorientation",h,{passive:!0});window.addEventListener("deviceorientation",this.update.bind(this),{passive:!0});k.domElement.addEventListener("touchstart",m,{passive:!1});k.domElement.addEventListener("touchmove",H,{passive:!1});k.enabled=!0};this.disconnect=function(){window.removeEventListener("orientationchange",B,{passive:!0});window.removeEventListener("deviceorientation",h,{passive:!0});window.removeEventListener("deviceorientation",this.update.bind(this),
{passive:!0});k.domElement.removeEventListener("touchstart",m,{passive:!1});k.domElement.removeEventListener("touchmove",H,{passive:!1});k.enabled=!1};this.update=function(a){if(!1!==k.enabled){a=null!=k.deviceOrientation.alpha?e.Math.degToRad(k.deviceOrientation.alpha)+k.alphaOffsetAngle-k.initialViewOffsetAngle:k.alphaOffsetAngle;var c=null!=k.deviceOrientation.beta?e.Math.degToRad(k.deviceOrientation.beta):1.6,f=null!=k.deviceOrientation.gamma?e.Math.degToRad(k.deviceOrientation.gamma):0,h=k.screenOrientation?
e.Math.degToRad(k.screenOrientation):0,d=k.camera.quaternion,g=new e.Vector3(0,0,1),B=new e.Euler,m=new e.Quaternion,n=new e.Quaternion(-Math.sqrt(.5),0,0,Math.sqrt(.5)),H=new e.Quaternion,l=new e.Quaternion;if(0==k.screenOrientation){var q=new e.Vector3(1,0,0);H.setFromAxisAngle(q,-b)}else 180==k.screenOrientation?(q=new e.Vector3(1,0,0),H.setFromAxisAngle(q,b)):90==k.screenOrientation?(q=new e.Vector3(0,1,0),H.setFromAxisAngle(q,b)):-90==k.screenOrientation&&(q=new e.Vector3(0,1,0),H.setFromAxisAngle(q,
-b));n.multiply(H);n.multiply(l);B.set(c,a,-f,"YXZ");d.setFromEuler(B);d.multiply(n);d.multiply(m.setFromAxisAngle(g,-h));k.alpha=a}};this.updateAlphaOffsetAngle=function(b){this.alphaOffsetAngle=b;0==a&&(a=b);this.update()};this.getRotations=function(){return{h:k.alpha,v:0}};this.dispose=function(){this.disconnect()};this.connect()}function ha(){var g=0<arguments.length&&void 0!==arguments[0]?arguments[0]:.064;this.format=null;this.eyeSep=g;this.loffset=new e.Vector2;this.roffset=new e.Vector2}function Ya(g){var d=
new e.OrthographicCamera(-1,1,1,-1,0,1),k=new e.Scene,a=new e.StereoCamera;a.aspect=.5;var b=new e.WebGLRenderTarget(512,512,{minFilter:e.LinearFilter,magFilter:e.NearestFilter,format:e.RGBAFormat});b.scissorTest=!0;b.texture.generateMipmaps=!1;var c=new e.Vector2(.441,.156),f=(new e.PlaneBufferGeometry(1,1,10,20)).deleteAttribute("normal").toNonIndexed(),h=f.attributes.position.array,B=f.attributes.uv.array;f.attributes.position.count*=2;f.attributes.uv.count*=2;var m=new Float32Array(2*h.length);
m.set(h);m.set(h,h.length);var H=new Float32Array(2*B.length);H.set(B);H.set(B,B.length);B=new e.Vector2;h=h.length/3;for(var n=0,T=m.length/3;n<T;n++){B.x=m[3*n];B.y=m[3*n+1];var p=B.dot(B);p=1.5+(c.x+c.y*p)*p;var l=n<h?0:1;m[3*n]=B.x/p*1.5-.5+l;m[3*n+1]=B.y/p*3;H[2*n]=.5*(H[2*n]+l)}f.attributes.position.array=m;f.attributes.uv.array=H;c=new e.MeshBasicMaterial({map:b.texture});f=new e.Mesh(f,c);k.add(f);this.setEyeSeparation=function(b){a.eyeSep=b};this.setSize=function(a,c){g.setSize(a,c);var f=
g.getPixelRatio();b.setSize(a*f,c*f)};this.render=function(c,f,h,e,B){var m=h instanceof Za||h instanceof $a;c.updateMatrixWorld();m&&this.setEyeSeparation(h.stereo.eyeSep);null===f.parent&&f.updateMatrixWorld();a.update(f);f=b.width/2;var n=b.height;g.autoClear&&g.clear();m&&h.updateTextureToLeft();b.scissor.set(0,0,f,n);b.viewport.set(0,0,f,n);g.setRenderTarget(b);g.render(c,a.cameraL);g.clearDepth();m&&h.updateTextureToRight();b.scissor.set(f,0,f,n);b.viewport.set(f,0,f,n);g.setRenderTarget(b);
...
1])},addFace:function(a,b,c,d,e,g,k,p,l){var f=this.vertices.length;a=this.parseVertexIndex(a,f);b=this.parseVertexIndex(b,f);c=this.parseVertexIndex(c,f);this.addVertex(a,b,c);void 0!==d&&""!==d&&(c=this.uvs.length,a=this.parseUVIndex(d,c),b=this.parseUVIndex(e,c),c=this.parseUVIndex(g,c),this.addUV(a,b,c));void 0!==k&&""!==k&&(d=this.normals.length,a=this.parseNormalIndex(k,d),b=k===p?a:this.parseNormalIndex(p,d),c=k===l?a:this.parseNormalIndex(l,d),this.addNormal(a,b,c));0<this.colors.length&&
...
f.objLoader=new fb;f.loadMtlObj(a,b,c);f.name=q.DOLLHOUSE;f.type=q.DOLLHOUSE;f.isInfospotVisible=!1;f.container=null;f.addEventListener("click",f.onClick.bind(r(f)));f.addEventListener("panolens-container",f.setContainer.bind(r(f)));return f}D(d,g);var k=E(d);G(d,[{key:"add",value:function(a){var b=this;if(a instanceof aa){var c=this.container;a.addEventListener("select-dollspot",function(a){b.dispatchEvent({type:"dollhouse-select-dollspot",dollspot:a.dollspot})});c&&a.dispatchEvent({type:"panolens-container",
...
f.show();f.unslideAll()})}var c=this,f=this.createMenu();f._width=200;f.changeSize(f._width);a=da(a);var h;try{for(a.s();!(h=a.n()).done;){var d=h.value,e=f.addItem(d.title);e.style.paddingLeft="20px";e.addIcon().addEventListener(c.TOUCH_ENABLED?"touchend":"click",b,!1);d.subMenu&&0<d.subMenu.length&&e.addSelection(d.subMenu[0].title).addSubMenu(d.title,d.subMenu)}}catch(H){a.e(H)}finally{a.f()}return f}},{key:"createSubMenu",value:function(a,b){function c(a){a.preventDefault();a.stopPropagation();
...
void 0!==arguments[0]?arguments[0]:16777215,b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:!0,c=2<arguments.length&&void 0!==arguments[2]?arguments[2]:1500;C(this,d);var f=window.devicePixelRatio,h=function(){var a=document.createElement("canvas"),b=a.getContext("2d");a.width=32*f;a.height=32*f;b.scale(f,f);b.shadowBlur=5;b.shadowColor="rgba(200,200,200,0.9)";return{canvas:a,context:b}}(),g=h.canvas;h=h.context;var m=new e.SpriteMaterial({color:a,map:function(a){a=new e.CanvasTexture(a);
a.minFilter=e.LinearFilter;a.magFilter=e.LinearFilter;a.generateMipmaps=!1;return a}(g)});m=k.call(this,m);m.dpr=f;m.canvasWidth=g.width;m.canvasHeight=g.height;m.context=h;m.color=a instanceof e.Color?a:new e.Color(a);m.autoSelect=b;m.dwellTime=c;m.rippleDuration=500;m.position.z=-10;m.center.set(.5,.5);m.scale.set(.5,.5,1);m.startTimestamp=null;m.timerId=null;m.callback=null;m.frustumCulled=!1;m.updateCanvasArcByProgress(0);return m}D(d,g);var k=E(d);G(d,[{key:"setColor",value:function(a){this.material.color.copy(a instanceof
...
f=this.canvasHeight,d=this.material,e=this.rippleDuration,g=performance.now(),k=this.color,n=this.dpr,l=.5*c/n,p=.5*f/n;this.dispatchEvent({type:"reticle-ripple-start"});(function z(){var h=window.requestAnimationFrame(z),m=(performance.now()-g)/e,B=0<1-m?1-m:0,H=m*c*.5/n;b.clearRect(0,0,c,f);b.beginPath();b.arc(l,p,H,0,2*Math.PI);b.fillStyle="rgba(".concat(255*k.r,", ").concat(255*k.g,", ").concat(255*k.b,", ").concat(B,")");b.fill();b.closePath();1<=m&&(window.cancelAnimationFrame(h),a.updateCanvasArcByProgress(0),
...
new e.Color(16777215);f.showTitleHotspotInfospot=void 0!==c.showTitleHotspotInfospot?c.showTitleHotspotInfospot:!1;f.isHiddenDuringTransition=!1;f.options=u({isHide:!1},c);c=new e.TextureLoader;f.type=t.FLOOR_RING_INFOSPOT;f.subtype=t.FLOOR_RING_INFOSPOT;f.animated=void 0!==b?b:!0;f.isHovering=!1;f.element=null;f.toPanorama=null;f.cursorStyle=null;f.mode=y.NORMAL;f.loaded=!1;f.scale.set(a,a,a);f.rotateX(-Math.PI/2);f.container=null;f.originalRaycast=f.raycast;f.HANDLER_FOCUS=null;f.geometry=new e.CircleGeometry(1.4,
...
c.load("data:image/svg+xml;base64,PHN2ZyBmaWxsPSJub25lIiBoZWlnaHQ9IjE0MCIgdmlld0JveD0iMCAwIDE0MCAxNDAiIHdpZHRoPSIxNDAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PHBhdGggZD0ibTAgMGgxNDB2MTQwaC0xNDB6IiBmaWxsPSIjZmZmIi8+PGNpcmNsZSBjeD0iNzAiIGN5PSI3MCIgZmlsbD0iIzAwMCIgcj0iNTAiLz48L3N2Zz4=",a);return f}D(d,g);var k=E(d);G(d,[{key:"setContainer",value:function(a){if(a instanceof HTMLElement)var b=a;else a&&a.container&&(b=a.container);b&&this.element&&b.append(this.element);this.container=b}},{key:"getContainer",
...
h.showTitleHotspotInfospot=void 0!==f.showTitleHotspotInfospot?f.showTitleHotspotInfospot:!1;h.isHiddenDuringTransition=!1;h.maxOpacity=void 0!==f.opacity?1*f.opacity:1;h.minOpacity=0;h.frustumCulled=!1;h.element=null;h.toPanorama=null;h.cursorStyle=null;h.mode=y.NORMAL;h.loaded=!1;h.scale.set(a,a,1);h.rotation.y=Math.PI;h.container=null;h.originalRaycast=h.raycast;h.HANDLER_FOCUS=null;h.material.side=e.DoubleSide;h.material.depthTest=!1;h.material.transparent=!0;h.material.opacity=0;h.visible=!1;
...
1)},offset:{value:new e.Vector2(0,0)},opacity:{value:1}},R=function(g){function d(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:d.createGeometry();var b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:d.createMaterial();C(this,d);a=k.call(this,a,b);a.type=q.PANORAMA;a.ImageQualityLow=1;a.ImageQualityFair=2;a.ImageQualityMedium=3;a.ImageQualityHigh=4;a.ImageQualitySuperHigh=5;a.animationDuration=1E3;a.defaultInfospotSize=350;a.container=void 0;a.loaded=!1;a.linkedSpots=[];a.isInfospotVisible=
...
a.onNotParallaxTransitionStart.bind(r(a)));a.addEventListener("not-parallax-transition-complete",a.onNotParallaxTransitionComplete.bind(r(a)));a.setupTransitions();return a}D(d,g);var k=E(d);G(d,[{key:"add",value:function(a){if(1<arguments.length){for(var b=0;b<arguments.length;b++)this.add(arguments[b]);return this}a.type!==t.INFOSPOT&&a.subtype!==t.FLOOR_RING_INFOSPOT||this.dispatchInfospotListeners(a);A(w(d.prototype),"add",this).call(this,a);this.dispatchEvent({type:"addChild"})}},{key:"dispatchInfospotListeners",
...
uniforms:a,side:e.BackSide,transparent:!0})}}]);return d}(R),jb=function(g){function d(a){var b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{};C(this,d);var c=k.call(this,d.createGeometry(),d.createMaterial());c.options=u({},b);c.container=a;c.passThrough=!0;c.subtype=U.SPOT_SPHERE;return c}D(d,g);var k=E(d);G(d,[{key:"dispose",value:function(){var a=this.geometry,b=this.material;a&&(a.dispose(),this.geometry=null);b&&(b.dispose(),this.material=null)}}],[{key:"createGeometry",value:function(){return new e.SphereBufferGeometry(5050,
...
null;a.addEventListener("fov",a._handleFovChange);return a}D(d,g);var k=E(d);G(d,[{key:"onLoad",value:function(){A(w(d.prototype),"onLoad",this).call(this);this._setTexture(this.srcTexture);this.geometry.setAttribute("uv",this.geometry.getAttribute("originaluv").clone());this.previewTextureLoaded=!0}},{key:"refresh",value:function(){if(!(3<=this.tilesUploadingToGPU)&&this.geometry&&this.previewTextureLoaded){this.camera.updateMatrixWorld();Pa.multiplyMatrices(this.camera.projectionMatrix,this.camera.matrixWorldInverse);
Oa.setFromProjectionMatrix(Pa);for(var a=this.geometry.getAttribute("position"),b=[],c=0;6>c;c++)for(var f=0;f<this.tilesByEdge;f++)for(var d=0;d<this.tilesByEdge;d++){var g=[],m=384*c+f*this.segmentsByTile*48+d*this.segmentsByTile*6,k=m+48*(this.segmentsByTile-1)+1;g.push(m,k,k+6*this.segmentsByTile-3,m+6*this.segmentsByTile-1);if(4<=this.segmentsByTile){var n=m+48*(this.segmentsByTile/2-1)+1;g.push(m+this.segmentsByTile/2*6-1,k+this.segmentsByTile/2*6-3,n,n+6*this.segmentsByTile-3,n+this.segmentsByTile/
...
new e.Texture(c);d.minFilter=d.magFilter=e.LinearFilter;b.renderer.initTexture(d);d.needsUpdate=!0;d=new e.MeshBasicMaterial({map:d,side:e.BackSide});b._swapMaterial(a.face,a.col,a.row,d);b.queue.set(b._tileId(a),{uploaded:!0})},0)})["catch"](function(){--b.tilesUploadingToGPU})}},{key:"_swapMaterial",value:function(a,b,c,d){for(var f=this,e=this.geometry.getAttribute("uv"),g=0;g<this.segmentsByTile;g++)for(var k=function(h){var k=384*a+6*(8*(c*f.segmentsByTile+g)+(b*f.segmentsByTile+h)),m=f.geometry.groups.find(function(a){return a.start===
k}).materialIndex;d.map.needsUpdate=!0;d.needsUpdate=!0;f.material[m]=d;f.material.needsUpdate=!0;m=1-g/f.segmentsByTile;var n=1-(g+1)/f.segmentsByTile,B=h/f.segmentsByTile;h=(h+1)/f.segmentsByTile;e.setXY(k,B,m);e.setXY(k+1,B,n);e.setXY(k+2,h,m);e.setXY(k+3,B,n);e.setXY(k+4,h,n);e.setXY(k+5,h,m)},n=0;n<this.segmentsByTile;n++)k(n);e.needsUpdate=!0}},{key:"handleEndOfTransition",value:function(){this.loadOtherTiles();this.removeEventListener("preview-texture-ready",this.handleEndOfTransition)}},{key:"dispose",
value:function(){delete this.srcTexture;delete this.loader;this.tilesUploadingToGPU=null;this.material.forEach(function(a){var b;null===a||void 0===a?void 0:null===(b=a.map)||void 0===b?void 0:b.dispose()});this.material.length=0;A(w(d.prototype),"dispose",this).call(this)}},{key:"addFloorPlane",value:function(){this.floorPlane&&this.floorPlane.subtype===U.FLOOR_PLANE||(this.floorPlane=new O,this.add(this.floorPlane))}},{key:"removeFloorPlane",value:function(){this.floorPlane&&this.floorPlane.subtype===
U.FLOOR_PLANE&&(this.floorPlane.dispose(),this.floorPlane=null)}}],[{key:"createMaterial",value:function(){return[]}},{key:"createGeometry",value:function(){var a=(new e.BoxBufferGeometry(12E3,12E3,12E3,8,8,8)).toNonIndexed();a.clearGroups();for(var b=0,c=0;2304>b;b+=6)a.addGroup(b,6,c++);b=a.attributes.position.array;c=a.attributes.uv.array;for(var d=0;d<b.length/3;d++){var h=b[3*d]/6E3,g=b[3*d+1]/6E3,k=b[3*d+2]/6E3,l=Math.sqrt(1/(Math.pow(h,2)+Math.pow(g,2)+Math.pow(k,2)));h*=l;g*=l;k*=l;l=Math.asin(g);
g=Math.atan2(h,k);0===h&&0>k&&(h=Math.floor(d/3),0>b[9*h]||0>b[9*(h+1)]||0>b[9*(h+2)])&&(g=-Math.PI);h=(l+Math.PI/2)/Math.PI;c[2*d]=(.5+(g+Math.PI)/(2*Math.PI))%1;c[2*d+1]=h}a.rotateY(-Math.PI/2);a.setAttribute("originaluv",a.getAttribute("uv").clone());return a}}]);return d}(R),mb={tEquirect:{value:new e.Texture},repeat:{value:new e.Vector2(1,1)},offset1:{value:new e.Vector2(0,0)},offset2:{value:new e.Vector2(0,0)},opacity:{value:1},tDiffuse1:{value:new e.Texture},tDiffuse2:{value:new e.Texture},
...
vertexShader:"\n        varying vec3 vWorldDirection;\n        #include <common>\n        void main() {\n            vWorldDirection = transformDirection( position, modelMatrix );\n            #include <begin_vertex>\n            #include <project_vertex>\n        }\n    ",uniforms:a,side:e.BackSide,transparent:!0}),b){var c=a;b=za(b);c.uniforms.offset2=b}return a}}]);return d}(R),ub=function(g){function d(){C(this,d);var a=new e.BufferGeometry,b=new e.MeshBasicMaterial({color:0,opacity:0,transparent:!0});
a.addAttribute("position",new e.BufferAttribute(new Float32Array,1));return k.call(this,a,b)}D(d,g);var k=E(d);return d}(R),vb=function(e){function d(){C(this,d);var a=[];for(var b=0;6>b;b++)a.push(L.WhiteTile);a=g.call(this,a);a.type=q.BASIC;return a}D(d,e);var g=E(d);return d}(function(g){function d(){var a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:[];C(this,d);var b=k.call(this,null,d.createMaterial());b.images=a;b.type=q.CUBE;return b}D(d,g);var k=E(d);G(d,[{key:"load",value:function(){A(w(d.prototype),
...
this).call(this)}}],[{key:"createMaterial",value:function(){var a=e.ShaderLib.cube,b=a.fragmentShader,c=a.vertexShader;a=e.UniformsUtils.clone(a.uniforms);a.opacity.value=0;return new e.ShaderMaterial({fragmentShader:b,vertexShader:c,uniforms:a,side:e.BackSide,transparent:!0,opacity:0})}}]);return d}(R)),Aa={tEquirect:{value:new e.Texture},repeat:{value:new e.Vector2(1,1)},offset:{value:new e.Vector2(0,0)},opacity:{value:1}},wb=function(g){function d(a){C(this,d);var b=k.call(this,d.createGeometry(),
d.createMaterial());b.subtype=q.SLIDER;b.desiredWidth=null;b.desiredHeight=null;b.desiredPosition=new e.Vector3(0,0,-2);b.src=a.url;b.backgroundMode=S.DEFAULT;return b}D(d,g);var k=E(d);G(d,[{key:"hide",value:function(){}},{key:"load",value:function(a){a=a||this.src;if(!a)console.warn("Image source undefined");else if("string"===typeof a)V.load(a,this.onLoad.bind(this),this.onProgress.bind(this),this.onError.bind(this));else if(a instanceof HTMLImageElement)this.onLoad(new e.Texture(a))}},{key:"onLoad",
...
vertexShader:"\n            #ifdef GL_ES\n            precision highp float;\n            #endif\n\n            varying vec2 texcoord;\n\n            void main()\n            {\n                gl_Position = projectionMatrix * modelViewMatrix * vec4(position,1.0);\n                texcoord  = uv;\n            }\n    ",uniforms:a,side:e.FrontSide,transparent:!0})}}]);return d}(R),ca=function(g){function d(a){var b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{};var c=2<arguments.length&&
void 0!==arguments[2]?arguments[2]:void 0;var e=3<arguments.length&&void 0!==arguments[3]?arguments[3]:d.createMaterial();C(this,d);c=k.call(this,c,e);e=document.createElement("video");c.src=a;c.isHls=!1;c.safeHls=P||window.Hls;c.TOUCH_ENABLED=!!("ontouchstart"in window||window.DocumentTouch&&document instanceof DocumentTouch);"m3u8"!==a.slice(-4)||pb||(c.safeHls&&c.safeHls.isSupported()?(e.title=a,c.hls=new c.safeHls({liveSyncDuration:1}),c.hls.loadSource(a),c.hls.attachMedia(e),c.setupHlsListeners(),
...
vertexShader:"\n        // Uniforms\n        uniform sampler2D tEquirect;\n        uniform sampler2D depthTexture;\n        uniform float pointSize;\n        uniform float displacement;\n\n        // Varyings passed to fragment\n        varying vec2 vUv;\n\n        // Internal\n        vec3 depthRgb;\n        float depth;\n\n        void main() {\n\n            /** Transform and pass to fragment shader */\n            vUv = uv;\n\n            /** Set the GL point size for when rendering points, ignored otherwise */\n            gl_PointSize = pointSize;\n\n            depthRgb = texture2D(depthTexture, vUv).rgb;\n            depth = depthRgb.r;\n\n\n            /** \n            * Invert the normals (since they are pointing outwards) and \n            * move the position on the normal direction scaled by the \n            * displacement which is the depth for the current vertex\n            * multiplied by a 'displacement' scalaer\n            **/\n            float disp = displacement * depth;\n            vec3 offset = position + (-normal) * disp;\n\n            /** Transform */\n            gl_Position = projectionMatrix *\n                            modelViewMatrix *\n                            vec4(offset, 1.0);\n        }\n    ",
uniforms:a,side:e.BackSide,transparent:!0})}}]);return d}(R),xb=function(g){function d(a){var b,c,f=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{};C(this,d);var h=k.call(this,a,f,d.createGeometry(),d.createMaterial());h.thumbUrl=f.thumbUrl;h.subtype=q.VIDEO_2D;h.desiredWidth=null===(b=f.dimensions)||void 0===b?void 0:b.width;h.desiredHeight=null===(c=f.dimensions)||void 0===c?void 0:c.height;h.desiredPosition=new e.Vector3(0,0,-2);h.backgroundMode=S.DEFAULT;return h}D(d,g);var k=E(d);G(d,
[{key:"onLoad",value:function(){window.requestAnimationFrame(A(w(d.prototype),"onLoad",this).bind(this));this.container.children[0].style.backgroundImage="url(".concat(this.thumbUrl,")");this.container.children[0].style.backgroundPosition="center";this.container.children[0].style.backgroundSize=this.backgroundMode===S.COLOR?"1%":"cover"}},{key:"updateBackgroundImage",value:function(a){this.container.children[0].style.backgroundImage="url(".concat(a,")")}}],[{key:"createGeometry",value:function(){return new e.PlaneBufferGeometry(1,
...
texture:3,transitionSpeed:-3,smoothstep:{start:.45,end:.99}}},NONE:{id:8,label:"None",value:"none",settings:{useTexture:!1,texture:0,transitionSpeed:-1E4,smoothstep:{start:.3,end:.7}}}},Ta=function(g){function d(a,b,c,f){var h,g,m=4<arguments.length&&void 0!==arguments[4]?arguments[4]:!1;C(this,d);var l=k.call(this);l.renderCount=0;l.fromScene=a;l.toScene=b;l.renderer=c;l.transitionParams=f;l.isInitiatorInfospot=m;l.clock=new e.Clock;l.transition=1;l.transitionScene=new e.Scene;l.cameraOrtho=new e.OrthographicCamera(window.innerWidth/
-2,window.innerWidth/2,window.innerHeight/2,window.innerHeight/-2,-10,10);l.updateParams(f);m=new e.TextureLoader;l.texture=m.load("/public/panolens/textures/transition/transition".concat(l.transitionParams.texture,".png"));l.texture.magFilter=e.LinearFilter;l.texture.minFilter=e.LinearFilter;l.texture.needsUpdate=!0;l.quadmaterial=new oa(l.transitionParams,l.texture);m=new e.PlaneBufferGeometry(window.innerWidth,window.innerHeight);l.quad=new e.Mesh(m,l.quadmaterial);l.transitionScene.add(l.quad);
m=function(){l.quadmaterial.uniforms.tDiffuse1.value=a.fbo.texture};var n=function(){l.quadmaterial.uniforms.tDiffuse2.value=b.fbo.texture};if(null!==a&&void 0!==a&&null!==(h=a.panorama)&&void 0!==h&&h.loaded)m();else{var q;null===a||void 0===a?void 0:null===(q=a.panorama)||void 0===q?void 0:q.addEventListener("ready",m)}if(null!==b&&void 0!==b&&null!==(g=b.panorama)&&void 0!==g&&g.loaded)n();else{var p;null===b||void 0===b?void 0:null===(p=b.panorama)||void 0===p?void 0:p.addEventListener("ready",
n)}return l}D(d,g);var k=E(d);G(d,[{key:"getTypeList",value:function(){return Object.keys(J).map(function(a){return u({},J[a])}).sort(function(a,b){return a.id-b.id})}},{key:"getTypeRelatedParameters",value:function(a){switch(a){case J.PERLIN.value:return u({},J.PERLIN.settings);case J.SQUARES.value:return u({},J.SQUARES.settings);case J.CELLS.value:return u({},J.CELLS.settings);case J.DISTORT.value:return u({},J.DISTORT.settings);case J.GRADIENT.value:return u({},J.GRADIENT.settings);case J.RADIAL.value:return u({},
...
this.fromScene){var b,c,d=this.fromScene,e=this.toScene;null===d||void 0===d?void 0:null===(b=d.panorama)||void 0===b?void 0:b.dispatchEvent({type:"not-parallax-transition-start"});null===e||void 0===e?void 0:null===(c=e.panorama)||void 0===c?void 0:c.dispatchEvent({type:"not-parallax-transition-start"})}a&&this.isInitiatorInfospot&&this.toScene.panorama.subtype!==q.SLIDER&&this.toScene.panorama.subtype!==q.SPIN&&(!this.fromScene||this.fromScene.panorama.subtype!==q.SLIDER&&this.fromScene.panorama.subtype!==
q.SPIN)&&this.parallax()}},{key:"destroy",value:function(){this.toScene.destroy();this.fromScene.destroy()}},{key:"parallax",value:function(){var a=this.fromScene,b=this.toScene;if(a){var c=a.lastTouch.scene||{x:0,y:0,z:0},d=a.camera.position,h=new e.Vector3;h.subVectors(d,c).normalize();d=new e.Vector3;a.camera.getWorldDirection(d);(new e.Vector3).subVectors(d,c.clone().normalize());c=h.multiply(new e.Vector3(-1,0,1));d=new e.Vector3;d=b.control.getRotations().h-a.control.getRotations().h;d=h.clone().applyAxisAngle(new e.Vector3(0,
1,0),d).normalize();h=d.clone();d=b.panorama.position.clone();c=(new v.Tween(a.panorama.position)).to({x:2E3*c.x,y:2E3*c.y,z:2E3*c.z},1500).easing(v.Easing.Cubic.Out);b.panorama.position.set(-2E3*h.x,h.y,-2E3*h.z);b.panorama.position.needsUpdate=!0;h=(new v.Tween(b.panorama.position)).to({x:d.x,y:d.y,z:d.z},1500).easing(v.Easing.Cubic.Out);c.start().onStart(function(){var b;null===a||void 0===a?void 0:null===(b=a.panorama)||void 0===b?void 0:b.dispatchEvent({type:"parallax-transition-start"})}).onComplete(function(){var b;
null===a||void 0===a?void 0:null===(b=a.panorama)||void 0===b?void 0:b.dispatchEvent({type:"parallax-transition-complete"})});h.start().onStart(function(){var a;null===b||void 0===b?void 0:null===(a=b.panorama)||void 0===a?void 0:a.dispatchEvent({type:"parallax-transition-start"})}).onComplete(function(){var a;null===b||void 0===b?void 0:null===(a=b.panorama)||void 0===a?void 0:a.dispatchEvent({type:"parallax-transition-complete"})})}}},{key:"render",value:function(){var a=this.cameraOrtho,b=this.clock,
c=this.quadmaterial,d=this.renderer,h=this.transitionParams,g=this.transitionScene;if(null===this.fromScene){var m,k;a=null!==(m=h.controlEnabled)&&void 0!==m?m:!0;this.toScene.render(!1);null!==(k=this.toScene)&&void 0!==k&&k.control&&(this.toScene.control.enabled=a);h.animateTransition=!1}else if(h.animateTransition&&(m=1+Math.sin(h.transitionSpeed*b.getElapsedTime()/Math.PI),this.transition=e.Math.smoothstep(m,h.smoothstep.start,h.smoothstep.end)),c.uniforms.mixRatio.value=this.transition,0===
this.transition){var n,l,p;a=h&&(h.controlEnabled||!1===h.controlEnabled)?h.controlEnabled:!0;this.toScene.render(!1);null!==(n=this.toScene)&&void 0!==n&&n.control&&(this.toScene.control.enabled=a);null!==(l=this.fromScene)&&void 0!==l&&l.control&&(this.fromScene.control.enabled=!1);h.animateTransition=!1;if("parallax"!==this.transitionParams.type&&this.fromScene){var q,r;null===(q=this.toScene)||void 0===q?void 0:null===(r=q.panorama)||void 0===r?void 0:r.dispatchEvent({type:"not-parallax-transition-complete"})}null===
(p=this.fromScene)||void 0===p?void 0:p.destroy();this.fromScene=null;this.dispatchEvent({type:"transition-complete"})}else if(1===this.transition){var t,I;h=h&&(h.controlEnabled||!1===h.controlEnabled)?h.controlEnabled:!0;this.fromScene.render(!1);null!==(t=this.toScene)&&void 0!==t&&t.control&&(this.toScene.control.enabled=h);null!==(I=this.fromScene)&&void 0!==I&&I.control&&(this.fromScene.control.enabled=h)}else{var u,v;h=h&&(h.controlEnabled||!1===h.controlEnabled)?h.controlEnabled:!0;this.fromScene.render(!0);
this.toScene.render(!0);null!==(u=this.toScene)&&void 0!==u&&u.control&&(this.toScene.control.enabled=h);null!==(v=this.fromScene)&&void 0!==v&&v.control&&(this.fromScene.control.enabled=h);d.setRenderTarget(null);d.clear();d.clearDepth();d.render(g,a)}}}]);return d}(e.EventDispatcher),yb=Array(21).fill(0).map(function(e,d){return d+1}),zb="\n  .sbs-widget {\n    display: none;\n    align-items: center;\n    flex-wrap: nowrap;\n    gap: 9px;\n    position: absolute;\n    top: calc(50% - 16px);\n    z-index: 2;\n  }\n\n  .sbs-resizer {\n    cursor: ew-resize;\n    width: 32px;\n    height: 32px;\n  }\n\n  .sbs-controls-bar {\n    display: flex;\n    box-sizing: border-box;\n    padding: 4px 10px;\n    align-items: center;\n    gap: 10px;\n    border-radius: 36px;\n    background: rgba(0, 0, 0, 0.50);\n  }\n\n  .sbs-options-btn {\n    cursor: pointer;\n    appearance: none;\n    border: none;\n    background: none;\n    width: 24px;\n    height: 24px;\n    padding: 0;\n  }\n\n  .sbs-rotation-offset-btn {\n    cursor: pointer;\n    appearance: none;\n    border: none;\n    background: none;\n    width: 24px;\n    height: 24px;\n    padding: 0;\n  }\n\n  .sbs-rotation-offset-bar {\n    display: flex;\n    box-sizing: border-box;\n    align-items: center;\n    gap: 10px;\n  }\n\n  .sbs-rotation-offset-close-btn {\n    display: flex;\n    cursor: pointer;\n    width: 32px;\n    height: 32px;\n    padding: 6px 4px;\n    justify-content: center;\n    align-items: center;\n    gap: 2px;\n    border: none;\n    border-radius: 24px;\n    background: rgba(0, 0, 0, 0.50);\n\n  }\n\n  .rotationOffsetControl__cross-button:hover {\n    background-color: #000;\n  }\n  \n  .sbs-rotation-offset-controls {\n    display: flex;\n    height: 31px;\n    padding: 6px 3px;\n    justify-content: center;\n    align-items: center;\n    gap: 4px;\n    border-radius: 41px;\n    background: rgba(0, 0, 0, 0.50);\n  }\n\n  .sbs-rotation-offset-range__increase-btn,\n  .sbs-rotation-offset-range__decrease-btn {\n    align-items: center;\n    justify-content: center;\n    border: none;\n    width: 25px;\n    height: 25px;\n    padding: 5px;\n    padding-right: 8px;\n    border-radius: 56px;\n    background: transparent;\n    cursor: pointer;\n  }\n\n  .sbs-rotation-offset-range__increase-btn:disabled,\n  .sbs-rotation-offset-range__decrease-btn:disabled {\n    .sbs-rotation-offset-range__increase-btn:hover,\n    .sbs-rotation-offset-range__decrease-btn:hover {\n      background-color: #000;\n    }\n  }\n\n  .sbs-rotation-offset-range__increase-btn:hover,\n  .sbs-rotation-offset-range__decrease-btn:hover {\n    background-color: #000;\n  }\n\n  .sbs-rotation-offset-range__increase-btn {\n    transform: rotate(180deg);\n  }\n\n  .sbs-rotation-offset-range {\n    position: relative;\n    display: flex;\n    width: ".concat(132,
...
window.top}catch(n){return!0}};return h}D(d,g);var k=E(d);G(d,[{key:"add",value:function(a){this.viewer&&this.viewer.panorama instanceof ca&&this.viewer.removeWidget();this.viewer?this.targetViewer=a:this.viewer=a;this.viewersQueue.push(a);a.panorama instanceof ca||this.removeVideoWidget();a.panorama instanceof Sa?(this.mode=y.SIDE_BY_SIDE,a.mode=this.mode,a.sideBySideDivider=this.sideBySideDivider,a.sideBySideDivider.initialize({offsetAngle:a.panorama.offsetAngle,setOffsetDegreeSideB:a.panorama.setOffsetDegreeSideB}),
...
null);b&&(b.dispose(),this.material=null)}}],[{key:"createGeometry",value:function(){return new e.SphereGeometry(.5,30,1,0,2*Math.PI,1,1)}},{key:"createMaterial",value:function(){return new e.MeshToonMaterial({color:302836,transparent:!0,opacity:0})}}]);return d}(e.Mesh),Hb=function(g){function d(a,b,c,f){var h=4<arguments.length&&void 0!==arguments[4]?arguments[4]:function(){},g=5<arguments.length&&void 0!==arguments[5]?arguments[5]:{};C(this,d);var m=k.call(this,d.createGeometry(),d.createMaterial());
m.subtype=q.SPIN;m.options=u({onLoadOneCallback:function(){},onLoadPassCallback:function(){},onInitialAutoRotateFinished:function(){},numberOfPasses:null,preview:null},g);m.onInitialAutoRotateFinished=function(){return m.options.onInitialAutoRotateFinished()};m.initialSpinFrame=m.options.initialSpinFrame||0;m.initialSpinZoom=m.options.initialSpinZoom||75;m.currentSide=m.initialSpinFrame;m.backgroundMode=m.options.backgroundMode||S.DEFAULT;m.desiredWidth=m.options.desiredWidth||null;m.desiredHeight=
m.options.desiredHeight||null;m.desiredPosition=new e.Vector3(0,0,-2);m.position.copy(m.desiredPosition);m.src=m.options.preview||a&&a[m.initialSpinFrame];m.currentSideTexture=null;m.currentSide=null;if(!m.src)return console.error("Spin Panorama: the array of images is empty."),Ea(m);m.spotModel=new Gb(m.container);m.spotModel.scale.set(1,1,1);m.spotModel.position.set(0,0,0);m.spotModel.rotation.y+=m.initialSpinFrame/a.length*Math.PI*2;m.add(m.spotModel);var l=m.options.numberOfPasses||Math.ceil(Math.log2(a.length));
m.texturesArray=Array(a.length);var n=function(a){return a===l-1?Math.pow(2,a):Math.pow(2,a+1)},r=function(b){return b===l-1?m.initialSpinFrame:(m.initialSpinFrame+Math.pow(2,b))%a.length},p=function(){return Object.values(t).reduce(function(a,b){return a+=b.count},0)/a.length},t=Array(l).fill(0).map(function(a,b){return b}).reduce(function(b,c){var d=Math.ceil((a.length-r(c))/n(c));b[c]={total:d,count:0};return b},{});m.setUpSpinEnvironment=function(d){m.container.children[0].style.backgroundImage=
"url(".concat(a[m.initialSpinFrame],")");m.container.children[0].style.backgroundPosition="center";m.container.children[0].style.backgroundSize=m.backgroundMode===S.COLOR?"1%":"cover";m.desiredWidth=m.spotModel.desiredWidth=m.desiredWidth||d.image.width;m.desiredHeight=m.spotModel.desiredHeight=m.desiredHeight||d.image.height;for(var e=0;e<a.length;e++)m.texturesArray[e]=d;m.controls=new pa(b,c,m.spotModel,f,m.texturesArray.length,m.initialSpinFrame);m.controls.addEventListener("rotation",m.onRotation,
!1);m.controls.addEventListener("initial-auto-rotate-finished",m.onInitialAutoRotateFinished,!1);v(l-1)};m.onRotation=function(b){var c;b=b.data.currentSide;m.currentSide===b||null!==(c=m.texturesArray[b])&&void 0!==c&&c.isBadUrl||(m.currentSide=b,c=m.currentSideTexture,m.currentSideTexture=m.texturesArray[b],null===c||void 0===c?void 0:c.dispose(),m.updateTexture(m.currentSideTexture),m.material.needsUpdate=!0,m.needsUpdate=!0,m.src=a[b])};m.rotateBySide=function(b){m.onRotation(b);m.spotModel.rotation.y+=
(b.data.currentSide-m.currentSide)/a.length*Math.PI*2;m.currentSide=b.data.currentSide};var v=function(b){for(var c=r(b),d=n(b),e=function(c){var d=c%a.length;V.load(a[d],function(c){t[b].count++;for(var e=0;e<n(b)/2;e++)d+e>=a.length||(m.texturesArray[d+e]=c);c=p();c===1/a.length&&m.dispatchEvent({type:"first-image-loaded"});m.options.onLoadOneCallback(c);t[b].count===t[b].total&&(m.options.onLoadPassCallback(b),0===b?(h(),m.controls.texturesLoaded=!0,m.options.disabledAutoAnimation||m.controls.animate(!1,
m.initialSpinFrame)):v(b-1))})},f=c;f<a.length+c;f+=d)e(f)};return m}D(d,g);var k=E(d);G(d,[{key:"load",value:function(a){a=a||this.src;if(!a)console.warn("Image source undefined");else if("string"===typeof a)V.load(a,this.onLoad.bind(this),this.onProgress.bind(this),this.onError.bind(this));else if(a instanceof HTMLImageElement)this.onLoad(new e.Texture(a))}},{key:"add",value:function(a){a.type===t.INFOSPOT?(this.dispatchInfospotListeners(a),this.spotModel.add(a)):A(w(d.prototype),"add",this).call(this,
...
g?void 0:null===(m=g.uniforms)||void 0===m?void 0:null===(k=m.tEquirect)||void 0===k?void 0:k.value.dispose()}this.texturesArray.forEach(function(a){a.dispose()});null===(f=this.controls)||void 0===f?void 0:f.removeEventListener("rotation",this.onRotation,!1);null===(h=this.controls)||void 0===h?void 0:h.removeEventListener("initial-auto-rotate-finished",this.onInitialAutoRotateFinished,!1);e.Cache.remove(this.src);A(w(d.prototype),"dispose",this).call(this)}}],[{key:"createGeometry",value:function(){return new e.PlaneBufferGeometry(1,
1)}},{key:"createMaterial",value:function(){var a=e.UniformsUtils.clone(Aa);a.repeat.value.copy(new e.Vector2(1,1));a.offset.value.copy(new e.Vector2(0,0));a.opacity.value=0;return new e.ShaderMaterial({fragmentShader:"\n            #ifdef GL_ES\n            precision highp float;\n            #endif\n\n            varying vec2 texcoord;\n            uniform sampler2D tEquirect;\n\n            void main()\n            {\n                /* Set color of the fragment */\n                gl_FragColor = texture2D(tEquirect, texcoord);}\n                \n    ",
vertexShader:"\n            #ifdef GL_ES\n            precision highp float;\n            #endif\n\n            varying vec2 texcoord;\n\n            void main()\n            {\n                gl_Position = projectionMatrix * modelViewMatrix * vec4(position,1.0);\n                texcoord  = uv;\n            }\n    ",uniforms:a,side:e.FrontSide,transparent:!0})}}]);return d}(R);fa.prototype=Object.create(e.EventDispatcher.prototype);fa.prototype.constructor=fa;Y.prototype=Object.assign(Object.create(e.EventDispatcher.prototype),
...
var Za=function(g){function d(a){var b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:new ha;C(this,d);var c=k.call(this,a);c.type=q.STEREO_IMAGE;c.stereo=b;return c}D(d,g);var k=E(d);G(d,[{key:"onLoad",value:function(a){var b=a.image;this.stereo.updateUniformByFormat(4===b.width/b.height?X.SBS:X.TAB,this.material.uniforms);this.material.uniforms.tEquirect.value=a;A(w(d.prototype),"onLoad",this).call(this,a)}},{key:"updateTextureToLeft",value:function(){this.stereo.updateTextureToLeft(this.material.uniforms.offset.value)}},
{key:"updateTextureToRight",value:function(){this.stereo.updateTextureToRight(this.material.uniforms.offset.value)}},{key:"dispose",value:function(){var a=this.material.uniforms.tEquirect.value;a instanceof e.Texture&&a.dispose();A(w(d.prototype),"dispose",this).call(this)}}]);return d}(ua),$a=function(g){function d(a){var b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{};var c=2<arguments.length&&void 0!==arguments[2]?arguments[2]:new ha;C(this,d);b=k.call(this,a,b);b.type=q.STEREO_VIDEO_PANORAMA;
b.stereo=c;return b}D(d,g);var k=E(d);G(d,[{key:"onLoad",value:function(a){var b=a.image;this.stereo.updateUniformByFormat(4===b.videoWidth/b.videoHeight?X.SBS:X.TAB,this.material.uniforms);this.material.uniforms.tEquirect.value=a;A(w(d.prototype),"onLoad",this).call(this)}},{key:"updateTextureToLeft",value:function(){this.stereo.updateTextureToLeft(this.material.uniforms.offset.value)}},{key:"updateTextureToRight",value:function(){this.stereo.updateTextureToRight(this.material.uniforms.offset.value)}},
...
c.cameraFov,h=c.defaultFov,g=c.controlBar,m=c.enableReticle,l=c.reverseDragging,n=c.output,q=c.scene,p=c.camera,t=c.renderer,w=c.scissorX;c=c.objectFit;var x=a.clientWidth,I=a.clientHeight,A={minFilter:e.LinearFilter,magFilter:e.LinearFilter};b.fbo=new e.WebGLRenderTarget(x,I,A);b.reticleFbo=new e.WebGLRenderTarget(x,I,A);b.container=a;b.scene=b.setupScene(q);b.sceneReticle=new e.Scene;b.defaultFov=h;b.camera=b.setupCamera(f,x/I,p);b.aux=b.setupAuxiliaryEntities();b.renderer=b.setupRenderer(t,a);
b.reticle=b.addReticle(b.camera,b.sceneReticle);b.control=b.setupControls(b.camera,a);b.effect=b.setupEffects(b.renderer,a);b.lastTouch={plane:null,scene:null};b.containerCursor=Q.GRAB;b.CURSORS=Q;b.objectFit=c;b.mode=y.NORMAL;b.panorama=null;b.widget=null;b.hoverObject=null;b.infospot=null;b.pressEntityObject=null;b.pressObject=null;b.raycaster=new e.Raycaster;b.raycasterPoint=new e.Vector2;b.userMouse=new e.Vector2;b.updateCallbacks=[];b.requestAnimationId=null;b.cameraFrustum=new e.Frustum;b.cameraViewProjectionMatrix=
...
b.onWindowResize.bind(r(b));b.handlerKeyDown=b.onKeyDown.bind(r(b));b.handlerKeyUp=b.onKeyUp.bind(r(b));b.handlerTap=b.onTap.bind(r(b),{clientX:x/2,clientY:I/2});g&&b.addDefaultControlBar(b.options.controlButtons);l&&b.reverseDraggingDirection();m?b.enableReticleControl():b.registerMouseAndTouchEvents();"overlay"===n&&b.addOutputElement();b.registerEventListeners();b.setupFloorCursor();return b}D(d,g);var k=E(d);G(d,[{key:"setupScene",value:function(){return 0<arguments.length&&void 0!==arguments[0]?
arguments[0]:new e.Scene}},{key:"setupCamera",value:function(a,b){var c=2<arguments.length&&void 0!==arguments[2]?arguments[2]:new e.PerspectiveCamera(a,b,1,11E3);c.position.z=1;return c}},{key:"setupRenderer",value:function(){return 0<arguments.length&&void 0!==arguments[0]?arguments[0]:new e.WebGLRenderer({alpha:!0,antialias:!1})}},{key:"setupControls",value:function(a,b){var c=this.options,d=c.autoRotate,e=c.autoRotateSpeed,g=c.horizontalView,m=c.momentum,k=c.rotateSpeed,n=c.dampingFactor,l=c.horizontalViewLimit,
p=c.horizontalViewDownLimitDegrees,q=c.horizontalViewUpLimitDegrees;c=new Y(a,b);c.id="orbit";c.index=N.ORBIT;c.minDistance=1;c.noPan=!0;c.autoRotate=d;c.autoRotateSpeed=e;c.momentum=m;c.rotateSpeed=k;c.dampingFactor=n;c.enabled=!0;c.addEventListener("fov",this.dispatchEventToChildren.bind(this));a=new ra(a,b);a.id="device-orientation";a.index=N.DEVICEORIENTATION;a.enabled=!1;g&&(c.minPolarAngle=Math.PI/2,c.maxPolarAngle=Math.PI/2);!g&&l&&(c.minPolarAngle=Math.PI/180*p,c.maxPolarAngle=Math.PI/180*
...
360*Math.PI),g=this.camera.aspect/c*d,k=this.defaultFov||60,m;"cover"==this.objectFit?m=Math.max(d,g)*(this.camera.position.z-a.position.z):"contain"==this.objectFit&&(m=d>g?g*(this.camera.position.z-a.position.z):d*(this.camera.position.z-a.position.z));m*=k/this.camera.fov;a.scale.set(m*c,m,1);a.subtype===q.SPIN&&(a.spotModel.scale.set(1,1,1),a.spotModel.scale.set(a.spotModel.scale.x/c,a.spotModel.scale.y,a.spotModel.scale.z/c));null===(b=a.children)||void 0===b?void 0:b.forEach(function(b){if(!b.alreadyScaled&&
a.subtype!==q.SPIN&&b.type===t.INFOSPOT){b.scale.set(b.scale.x/c,b.scale.y,b.scale.z);b._parentRatio=c;var d=new e.Vector3;d.copy(b.scale);b.scaleUpAnimation=(new v.Tween(b.scale)).to({x:1.3*d.x,y:1.3*d.y},500).easing(v.Easing.Elastic.Out);b.scaleDownAnimation=(new v.Tween(b.scale)).to({x:d.x,y:d.y},500).easing(v.Easing.Elastic.Out);null!=b.map&&(b.map.needsUpdate=!0);b.needsUpdate=!0;b.updateMatrixWorld();a.updateMatrixWorld();b.alreadyScaled=!0}});this.currentScale=m;this.currentRatio=c;this.panorama.subtype===
q.SPIN&&(this.OrbitControls.maxFov=this.camera.fov,this.setCameraFov(this.panorama.initialSpinZoom||this.camera.fov))}}},{key:"remove",value:function(a){a.removeEventListener&&a.removeEventListener("panolens-viewer-handler",this.eventHandler.bind(this));this.scene.remove(a)}},{key:"addDefaultControlBar",value:function(a){if(!this.widget){var b=new Ja(this.container);b.addEventListener("panolens-viewer-handler",this.eventHandler.bind(this));b.addControlBar();a.forEach(function(a){b.addControlButton(a)});
...
l=this.tweenCanvasOpacityOut,n=this.tweenCanvasOpacityIn,q=this.container.querySelector("canvas");if(b!==d){if(b===N.DEVICEORIENTATION)l.onStart(function(){g.enabled=!1;k.enabled=!1;c?q.style.opacity=0:null}),n.onStart(function(){g.enabled=!0;k.updateAlphaOffsetAngle(g.publicSphericalDelta.data.theta);k.connect();c?q.style.opacity=1:null});else{d=k.getRotations;d();var p=this.getRaycastViewCenter();l.onStart(function(){g.enabled=!1;k.disconnect();q.style.opacity=0});n.onStart(function(){g.enabled=
!0;a.setControlCenter(p);q.style.opacity=1})}l.start();this.control=e[b]}}},{key:"disableControl",value:function(){this.control.enabled=!1}},{key:"toggleNextControl",value:function(){this.enableControl(this.getNextControlIndex())}},{key:"getScreenVector",value:function(a){a=a.clone();var b=this.container.clientWidth/2,c=this.container.clientHeight/2;a.project(this.camera);a.x=a.x*b+b;a.y=-(a.y*c)+c;a.z=0;return a}},{key:"checkSpriteInViewport",value:function(a){this.camera.matrixWorldInverse.copy(this.camera.matrixWorld).invert();
...
b,c){Array.isArray(a)&&(c=a[2],b=a[1],a=a[0]);b=void 0!==b?b:400;c=c||v.Easing.Exponential.Out;var d=this.calculateCameraDirectionDelta(a);a=d.left;d=d.up;var e=this.rotateControlLeft.bind(this),g=this.rotateControlUp.bind(this),k={left:0,up:0},l=0,n=0;this.tweenLeftAnimation.stop();this.tweenUpAnimation.stop();this.tweenLeftAnimation=(new v.Tween(k)).to({left:a},b).easing(c).onUpdate(function(a){e(a.left-l);l=a.left}).start();this.tweenUpAnimation=(new v.Tween(k)).to({up:d},b).easing(c).onUpdate(function(a){g(a.up-
...
1,1);a=a.point.clone();a.multiply(b);if(0!==a.length())return a}},{key:"outputPosition",value:function(){var a=this,b=this.raycaster.intersectObject(this.panorama,!0);if(0<b.length){var c={plane:null,scene:null};b.forEach(function(d){if(d.object.subtype!==q.PROGRESSVIE_IMAGE||b.some(function(a){return a.object.subtype===U.FLOOR_PLANE}))if(d.object.subtype===U.FLOOR_PLANE){if(d=a.getPlanePosition(d))d.y+=+Math.random().toFixed(2);c.plane=d}else d.object.subtype===q.SLIDER||d.object.subtype===q.SIDE_BY_SIDE_2D||
d.object.subtype===q.VIDEO_2D?c.scene=a.getSliderPosition(d):d.object.subtype===q.IMAGE||d.object.subtype===q.VIDEO||d.object.subtype===q.SIDE_BY_SIDE?c.scene=a.get360Position(d):d.object.subtype===q.PROGRESSVIE_IMAGE?c.scene=a.get360Position(d):d.object.subtype===t.SPOT_MODEL&&(d=d.point.clone(),a.panorama.spotModel.worldToLocal(d),c.scene=d);else d=b.find(function(a){return a.object.subtype===U.SPOT_SPHERE}),c.scene=a.get360Position(d)});return this.lastTouch=c}}},{key:"onMouseDown",value:function(a){a.preventDefault();
...
a=a.changedTouches&&1===a.changedTouches.length?this.onTap({clientX:a.changedTouches[0].clientX,clientY:a.changedTouches[0].clientY},b):this.onTap(a,b),this.userMouse.type="none",!a&&"click"===b){b=this.options;a=b.autoHideControlBar;var c=this.panorama;b.autoHideInfospot&&c&&c.toggleInfospotVisibility();a&&this.toggleControlBar()}}},{key:"onTap",value:function(a,b){var c=this,d=this.container.getBoundingClientRect(),g=d.top,k=this.container,m=k.clientHeight;this.raycasterPoint.x=(a.clientX-d.left)/
k.clientWidth*2-1;this.raycasterPoint.y=2*-((a.clientY-g)/m)+1;this.raycaster.setFromCamera(this.raycasterPoint,this.camera);if(this.panorama){"mousedown"!==a.type&&this.outputPosition();this.floorCursor&&this.floorCursor.enabled&&(this.lastTouch&&this.lastTouch.plane&&this.floorCursor.position.set(-this.lastTouch.plane.x,this.lastTouch.plane.y+1,this.lastTouch.plane.z),this.floorCursor.onMove());d=this.raycaster.intersectObjects(this.panorama.children,!0);g=d.filter(function(a){var b;return!(null!==
(b=a.object)&&void 0!==b&&b.passThrough)});if(0<g.length){var l=g.find(function(a){var b;return(null===(b=a.object)||void 0===b?void 0:b.type)===t.INFOSPOT});k=g.find(function(a){var b;return(null===(b=a.object)||void 0===b?void 0:b.type)===t.NADIR});l=l&&k?l.object:g[0].object}"click"!==b||l&&l.type===t.NADIR||this.panorama.dispatchEvent({type:"clickOnAviablePlaceForAddSpot"});"click"===b?(this.panorama.dispatchEvent({type:"click",intersects:d,mouseEvent:a}),l&&l.dispatchEvent&&l.dispatchEvent({type:"click",
mouseEvent:a})):(this.panorama.dispatchEvent({type:"hover",intersects:d,mouseEvent:a}),this.hoverObject&&l!==this.hoverObject&&(this.hoverObject.dispatchEvent&&(this.hoverObject.dispatchEvent({type:"hoverleave",mouseEvent:a}),this.reticle.end()),this.hoverObject=void 0),l&&this.hoverObject!==l&&(this.hoverObject=l,this.hoverObject.dispatchEvent&&(this.hoverObject.dispatchEvent({type:"hoverenter",mouseEvent:a}),this.options.autoReticleSelect&&(this.options.enableReticle||this.tempEnableReticle)&&this.reticle.start(this.onTap.bind(this,
a,"click")))));if(!l||l.type!==t.INFOSPOT&&l.subtype!==t.FLOOR_RING_INFOSPOT)this.infospot&&"click"===b&&this.hideInfospot();else{this.infospot&&this.infospot!==l&&(this.infospot.unlockHoverElement(),this.hideInfospot());this.infospot=l;if("click"===b&&this.infospot.subtype!==t.HOTSPOT&&this.infospot.subtype!==t.FLOOR_RING_INFOSPOT&&this.panorama.subtype!==q.SPIN&&this.panorama.subtype!==q.SLIDER&&this.panorama.subtype!==q.VIDEO_2D&&this.panorama.subtype!==q.SIDE_BY_SIDE_2D)return this.tweenControlCenter(new e.Vector3(-l.position.x,
l.position.y,l.position.z)),!0;"click"===b&&this.infospot.subtype===t.HOTSPOT&&l.type!==t.NADIR&&setTimeout(function(){return c.setContainerCursor(Q.GRAB)},10)}this.options.autoRotate&&this.isProbablyDragging&&(clearTimeout(this.autoRotateRequestId),this.control===this.OrbitControls&&(this.OrbitControls.autoRotate=!1,this.dispatchEvent({type:"pauseAutoRotate"}),this.autoRotateRequestId=window.setTimeout(this.enableAutoRate.bind(this),this.options.autoRotateActivationDuration)))}}},{key:"hideInfospot",
...
a.y,a.z);this.aux.quaternion.setFromUnitVectors(c,a);this.aux.matrix.makeRotationFromQuaternion(this.aux.quaternion);b.applyMatrix(this.aux.matrix);b.updateMatrixWorld();b.updateProjectionMatrix();b=new Y(b,this.container);b.update(!0);return b.getRotations()}},{key:"update",value:function(){var a,b,c,d,g,k,l=this,r=this.scene,n=this.control,u=this.OrbitControls,p=this.DeviceOrientationControls,w=this.panorama;v.update();null===(a=this.updateCallbacks)||void 0===a?void 0:a.forEach(function(a){return a()});
(null===w||void 0===w?void 0:w.subtype)===q.PROGRESSVIE_IMAGE&&setTimeout(function(){return w.refresh()},0);u.enabled&&null!==(b=r.children[1])&&void 0!==b&&b.subtype&&(null===(c=r.children[1])||void 0===c?void 0:c.subtype)!==q.SPIN&&(null===(d=r.children[1])||void 0===d?void 0:d.subtype)!==q.SLIDER&&(null===(g=r.children[1])||void 0===g?void 0:g.subtype)!==q.VIDEO_2D&&(null===(k=r.children[1])||void 0===k?void 0:k.subtype)!==q.SIDE_BY_SIDE_2D&&u.update();n===p&&p.update();var x=new e.Vector3,y=function(a){var b=
l.hoverObject===a;(a.type===t.INFOSPOT||a.subtype===t.FLOOR_RING_INFOSPOT)&&a.element&&(b||a.showTitleHotspotInfospot||"none"!==a.element.style.display||a.element.left&&"none"!==a.element.left.style.display||a.element.right&&"none"!==a.element.right.style.display)&&(l.checkSpriteInViewport(a)?(b=l.getScreenVector(a.getWorldPosition(x)),a.translateElement(b.x,b.y),a.showTitleHotspotInfospot&&a.handleAlwaysShowTitle(!0)):(a.onDismiss(!1),a.handleAlwaysShowTitle(!1)))};this.camera.updateMatrixWorld();
...
1)?(this.renderer.setRenderTarget(this.fbo),this.renderer.clear(),this.effect.render(this.scene,this.camera,this.panorama,!0,this.fbo,{scissorX:this.scissorX}),this.mode!=y.SIDE_BY_SIDE&&this.effect.render(this.sceneReticle,this.camera,this.panorama,!0,this.fbo)):(this.renderer.setRenderTarget(null),this.renderer.clear(),this.effect.render(this.scene,this.camera,this.panorama,!1,null,{scissorX:this.scissorX}),this.mode!=y.SIDE_BY_SIDE&&this.effect.render(this.sceneReticle,this.camera,this.panorama,
...
b.type===q.PANORAMA||b.type===t.INFOSPOT||b.subtype===t.FLOOR_RING_INFOSPOT?b.dispose():b.dispatchEvent&&b.dispatchEvent("dispose")}this.disableAutoRate();this.tweenLeftAnimation.stop();this.tweenUpAnimation.stop();this.unregisterEventListeners();this.unregisterMouseAndTouchEvents();this.fbo.dispose();this.reticleFbo.dispose();this.DeviceOrientationControls.dispose();this.OrbitControls.dispose();this.aux&&this.aux.control&&this.aux.control.dispose();this.aux=null;a(this.scene);this.DragControls&&
...
b.onMouseMove.bind(r(b));b.handlerMouseUp=b.onMouseUp.bind(r(b));b.handlerMouseWheel=b.onMouseWheel.bind(r(b));b.handlerContextmenu=b.onContextmenu.bind(r(b));b.handlerWindowResize=b.onWindowResize.bind(r(b));b.registerEventListeners();b.animate();return b}D(d,g);var k=E(d);G(d,[{key:"setupCamera",value:function(a){var b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:new e.PerspectiveCamera(20,a,.1,1E4);b.updateWorldMatrix=function(a,b){e.Object3D.prototype.updateWorldMatrix.call(this,a,b)};
...
this.render();window.cancelAnimationFrame(this.requestAnimationId)}}]);return d}(e.EventDispatcher);"134"!=e.REVISION&&console.warn("three.js version is not matched. Please consider use the target revision ".concat("134"));window.TWEEN=v;l.BACKGROUNDS=S;l.BasicPanorama=vb;l.BulkImageLoader=Ga;l.BulkTextureLoader=ja;l.CONTROLS=N;l.CURSORS=Q;l.CURSOR_TYPES=sa;l.CubeTextureLoader=Ia;l.DataImage=L;l.DollViewer=Kb;l.Dollhouse=Ha;l.Dollspot=aa;l.EXTRA_GEOMETRY=U;l.EmptyPanorama=ub;l.FLOOR_PLANE_POSITION=
Z;l.FloorCursor=La;l.FloorPlane=O;l.FloorRingInfospot=gb;l.ID_FOR_CUSTOM_BUTTON=ta;l.ImageLittlePlanet=Fb;l.ImageLoader=ia;l.ImagePanorama=ua;l.Infospot=Ma;l.MODES=y;l.Nadir=hb;l.PANORAMA_TYPES=q;l.Panorama=R;l.ProgressiveImagePanorama=lb;l.REVISION="11";l.Reticle=Ka;l.SPOT_TYPES=t;l.STEREOFORMAT=X;l.SideBySidePanorama=Sa;l.SliderPanorama=wb;l.SpinPanorama=Hb;l.THREE_REVISION="134";l.THREE_VERSION=bb;l.TextureLoader=V;l.VERSION="0.11.0";l.Video2dPanorama=xb;l.VideoPanorama=ca;l.Viewer=Jb;l.ViewerManager=
Db;l.Widget=Ja;Object.defineProperty(l,"__esModule",{value:!0})});
